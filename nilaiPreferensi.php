            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        ...
                        <div class="card p-5">
                            <h2>Kesimpulan yang di dapat: </h2>
                            <h5>
                                Jika melihat data preferensi yang sudah didapatkan menunjukkan bahwa alternatif 2 (A2) yang berlokasi di Magetan mendapatkan nilai preferensi tertinggi dari 2 alternatif lainnya (A1, A3). maka dapat disimpulkan bahwa alternatif 2 (A2) Magetan yang akan dipilih sebagai lokasi pembangunan kampus baru.
                            </h5>
                        </div>
                    </div>
                </div>
