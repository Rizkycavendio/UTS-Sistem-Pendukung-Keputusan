        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <h2>Mencari Solusi Ideal Positif (maks) dan negatif(min): </h2>
                        <table class="table table-info table-striped table-bordered border-primary">
                            <tbody>
                                <tr>
                                    <th scope="col">Max(y+)</th>
                                    <td scope="col">Alternatif (A)</td>
                                    <td scope="col"><?= $topsis->ymax[0] ?></td>
                                    <td scope="col"><?= $topsis->ymax[1] ?></td>
                                    <td scope="col"><?= $topsis->ymax[2] ?></td>
                                    <td scope="col"><?= $topsis->ymax[3] ?></td>
                                    <td scope="col"><?= $topsis->ymax[4] ?></td>
                                </tr>
                                <tr>
                                    <th scope="col">Max(y-)</th>
                                    <td scope="col">Alternatif (A)</td>
                                    <td scope="col"><?= $topsis->ymin[0] ?></td>
                                    <td scope="col"><?= $topsis->ymin[1] ?></td>
                                    <td scope="col"><?= $topsis->ymin[2] ?></td>
                                    <td scope="col"><?= $topsis->ymin[3] ?></td>
                                    <td scope="col"><?= $topsis->ymin[4] ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
