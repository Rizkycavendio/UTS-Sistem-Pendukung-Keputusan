        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <h2>Data Pembagi Matriks Ternormalisasi:</h2>
                        <table class="table table-info table-striped table-bordered border-primary">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">Pembagi</th>
                                    <td><?= $topsis->pembagiMatrixTernormalisasi[0] ?></td>
                                    <td><?= $topsis->pembagiMatrixTernormalisasi[1] ?></td>
                                    <td><?= $topsis->pembagiMatrixTernormalisasi[2] ?></td>
                                    <td><?= $topsis->pembagiMatrixTernormalisasi[3] ?></td>
                                    <td><?= $topsis->pembagiMatrixTernormalisasi[4] ?></td>
                                </tr>
                            </tbody>
                        </table>
                        <h2>Matrix Ternormalisasi:</h2>
                        <table class="table table-info table-striped table-bordered border-primary">
                            <thead class="table-primary">
                                <tr>
                                    <th scope="col">Kode</th>
                                    <th scope="col">Alternatif (A)</th>
                                    <th scope="col">C1</th>
                                    <th scope="col">C2</th>
                                    <th scope="col">C3</th>
                                    <th scope="col">C4</th>
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $total = 0;
                                foreach ($topsis->matrixTernormalisasi as $mt) {
                                ?>
                                    <tr>
