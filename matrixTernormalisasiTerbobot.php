        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12">
                        <h2>Matrix Ternormalisasi Terbobot:</h2>
                        <table class="table table-info table-striped table-bordered border-primary">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $total = 0;
                                foreach ($topsis->matrixTernormalisasiTerbobot as $mtt) {
                                ?>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td scope="col"></td>
                                    <td scope="col"><?= $topsis->atribut[0] ?></td>
                                    <td scope="col"><?= $topsis->atribut[1] ?></td>
                                    <td scope="col"><?= $topsis->atribut[2] ?></td>
                                    <td scope="col"><?= $topsis->atribut[3] ?></td>
                                    <td scope="col"><?= $topsis->atribut[4] ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
